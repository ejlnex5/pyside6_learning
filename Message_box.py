...
class Widget(QWidget):
    ...
    def button_clicked_hard(self):
        ...
        message.setWindowTitle("Ay! Listen up!")
        message.setText("Something Happened")
        message.setInformativeText("What'll it be partnah?")
    ...
    def button_clicked_critical(self):
        ret = QMessageBox.critical(self,"CritiCalifornia",
                                    "Critical Message!", 
    ...
    def button_clicked_question(self):
        ret = QMessageBox.question(self,"Questionuuhhhh",
                                    "Asking Question!", 
                                     QMessageBox.Ok | QMessageBox.Cancel)
        if ret == QMessageBox.Ok:
            print("User chose OK")
    ...
    def button_clicked_information(self):
        ret = QMessageBox.information(self,"Info You Know",
    ...
    def button_clicked_warning(self):
        ret = QMessageBox.warning(self,"Warning Robot",
    ...
    def button_clicked_about(self):
        ret = QMessageBox.about(self,"About Me","I like to cook!")
