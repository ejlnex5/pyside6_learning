from PySide6.QtWidgets import QListWidget, QAbstractItemView, QRadioButton, QButtonGroup, QCheckBox, QGroupBox, QWidget, QLabel, QHBoxLayout, QVBoxLayout, QPushButton, QLineEdit, QSizePolicy, QGridLayout
...
class Widget(QWidget):
    ...
    def item_count(self):
        print("Item count : ", self.list_widget.currentRow())
